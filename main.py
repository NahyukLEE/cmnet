...
def main(args):
    ...
    GADataset.initialize(args.datapath, args.data_category, args.sub_category, args.n_pts, args.mpa)
...
if __name__ == '__main__':
    ...
    # Set the default epochs
    if args.epochs is None:
        args.epochs = 90 if args.data_category == 'everyday' else 120
        args.epochs = 300 if args.mpa else args.epochs
    ...
    if len(args.gpus) > 1: 
        ...
        args.n_worker = len(args.gpus) * args.n_worker
    else: 
